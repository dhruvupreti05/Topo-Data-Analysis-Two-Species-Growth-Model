...
Currently we are going through relavant reserach papers on Topological Data Analysis and Totally Asymmetric Diffusion on a Ring and updating notes to `notes/` folder.   
...
This work was created by the colaborative efforts of [Esha Sury](mailto:esury@purdue.edu) and [Dhruv Upreti](mailto:dupreti@purdue.edu). Mentorship was given by [Birgit Kaufmann](ebkaufma@purdue.edu).
